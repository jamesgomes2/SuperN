...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	wget -c -P /home https://raw.githubusercontent.com/jamesgomes2/SuperN/main/versao
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  echo -e " \033[1;33m MAIS INFORMACOES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@twossh\n"
  echo -ne " \033[1;31m ENTER \033[1;33mpara retornar ao \033[1;32mMENU!\033[0m"; read
  menu
} || {
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    sleep 3
    wget https://raw.githubusercontent.com/jamesgomes2/SuperN/main/Plus > /dev/null 2>&1
    chmod +x Plus
    ./Plus
    clear
